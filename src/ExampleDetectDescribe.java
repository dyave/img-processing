...
//		return (DetectDescribePoint)FactoryDetectDescribe.sift(new ConfigCompleteSift(-1,5,300));
	...
	public static void main( String args[] ) {
        if (args.length != 2) {
            System.out.println(">>> Error with arguments. Speficy 2 paths of images. Example:");
            System.out.println("./kayak_01.jpg ./kayak_03.jpg");
            System.exit(1);
        }
		BufferedImage imageA = UtilImageIO.loadImage(UtilIO.pathExample(args[0]));
		BufferedImage imageB = UtilImageIO.loadImage(UtilIO.pathExample(args[1]));
